<div>
        ...
        <div class="relative isolate px-6 pt-14 lg:px-8">
          ...
          <div class="mx-auto max-w-2xl py-12 sm:py-28 lg:py-40">
            <div class="text-center">
              <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">{{ __('construction/page.title') }}</h1>
    ...
    <!-- END SECTION2 -->
      ...
      <div class="relative isolate overflow-hidden bg-white px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">
        ...
        <div class="-ml-12 -mt-12 p-12 lg:sticky lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden">
          <div class="flex items-center flex-col space-y-6">
                ...
                <img x-show="id === 1" class=" h-[27rem] object-contain rounded-xl bg-gray-200 shadow-xl ring-1 ring-gray-400/10" src="images/construct/construct1.jpeg" alt="">
                <img x-show="id === 2" class=" h-[27rem] object-contain rounded-xl bg-gray-200 shadow-xl ring-1 ring-gray-400/10" src="images/construct/construct2.jpeg" alt="">
                <img x-show="id === 3" class=" h-[27rem] object-contain rounded-xl bg-gray-200 shadow-xl ring-1 ring-gray-400/10" src="images/construct/construct3.jpeg" alt="">
                <img x-show="id === 4" class=" h-[27rem] object-contain rounded-xl bg-gray-200 shadow-xl ring-1 ring-gray-400/10" src="images/construct/construct4.JPG" alt="">
                <img x-show="id === 5" class=" h-[27rem] object-contain rounded-xl bg-gray-200 shadow-xl ring-1 ring-gray-400/10" src="images/construct/construct5.JPG" alt="">
                <img x-show="id === 6" class=" h-[27rem] object-contain rounded-xl bg-gray-200 shadow-xl ring-1 ring-gray-400/10" src="images/construct/construct6.JPG" alt="">
                <img x-show="id === 7" class=" h-[27rem] object-contain rounded-xl bg-gray-200 shadow-xl ring-1 ring-gray-400/10" src="images/construct/construct7.JPG" alt="">
                <img x-show="id === 8" class=" h-[27rem] object-contain rounded-xl bg-gray-200 shadow-xl ring-1 ring-gray-400/10" src="images/construct/construct8.JPG" alt="">
              ...
              <div class="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
                <ul role="list" class="mt-8 space-y-8 text-gray-600">
                  <li class="gap-y-3 items-center">
                    <img src="images/construct.svg" alt="" class="object-cover h-96">
                    <span class="text-xl"><div class="font-semibold text-gray-900 text-4xl">{{ __('construction/page.first_part_photo') }}</div> <br>{{ __('construction/page.second_part_photo') }} </span>
                  </li>
                </ul>
              </div>
            </div>
      ...
      <div class="bg-gray-100 py-24 sm:py-32">
        <div class="mx-auto max-w-7xl px-6 lg:px-8 bg-white  py-4 rounded-xl">
            <p class="mt-6 text-2xl leading-8 text-blue-900 text-center"> {{ __('construction/page.middle_page') }}</p>
        ...
        <div class="mx-auto max-w-7xl py-24 sm:px-6 sm:py-32 lg:px-8">
          <div class="relative isolate overflow-hidden bg-gradient-to-r from-50-100 to text-teal-100 px-6 py-24 text-center shadow-2xl sm:rounded-3xl sm:px-16">
            <div class="flex items-center justify-center">
              ...
              <div>
                <h2 class="mx-auto max-w-2xl text-3xl font-bold tracking-tight text-blue-900 sm:text-4xl"> {{ __('construction/page.footer') }}</h2>
              </div>
            </div>
